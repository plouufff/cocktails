...
final class Version20210114155058 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE cocktail (id INT GENERATED BY DEFAULT AS IDENTITY, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, recipe TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7B4914D4989D9B62 ON cocktail (slug)');
        $this->addSql('CREATE TABLE cocktail_ingredient (id INT GENERATED BY DEFAULT AS IDENTITY, cocktail_id INT NOT NULL, ingredient_id INT NOT NULL, quantity INT NOT NULL, measure VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE ingredient (id INT GENERATED BY DEFAULT AS IDENTITY, ingredient_category_id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6BAF7870AA35537B ON ingredient (ingredient_category_id)');
        $this->addSql('CREATE TABLE ingredient_category (id INT GENERATED BY DEFAULT AS IDENTITY, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
